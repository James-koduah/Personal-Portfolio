let dropdown = document.getElementById('top_nav_dropdown')
function mobileNavDropdown(button){
    if (dropdown.classList.contains('dropActive')){
...
const technologiesWorkedWith = [
    ...
    "Polygon.io API",
    "Paddle API",
    "Google Sign-In (google.accounts.id)",
